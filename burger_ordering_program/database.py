...
cursor.execute('INSERT OR IGNORE INTO burgers (name, description, price) VALUES ("OSTBURGARE", "Osten är inte garranterad smält", "120")')
cursor.execute('INSERT OR IGNORE INTO burgers (name, description, price) VALUES ("VEGGIEBURGARE", "Får mat", "100")')
cursor.execute('INSERT OR IGNORE INTO burgers (name, description, price) VALUES ("BACONBURGARE", "Smarrig burgare med bejkon", "130")')
